...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            ...
            <div class="row intro py-1" style="background-color :#8edee2">
              <div class="col-sm-12 col-md">
			  <marquee>
                <div class="heading text-center my-5">
 
				  <h3 style="text-align:center">Welcome to</h3>
                  <h1 style="text-align:center">SPARKS BANK</h1>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    <img src="img/user.png" class="img-fluid" height="150" width="150">
                    <br>
                    <a href="createuser.php"><button style="background-color : #2785C4;">Create a User</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/trans.png" class="img-fluid" height="150" width="150">
                    <br>
                    <a href="transfermoney.php"><button style="background-color : #2785C4;">Make a Transaction</button></a>
                  </div>
                  <div class="col-md act">
                    <img src="img/history.png" class="img-fluid" height="150" width="150">
                    <br>
      ...
      <footer class="text-center mt-5 py-2">
        <p> Made by <b>KAVIYARANI GOWTHAMAN</b> <br> Sparks Foundation <br> copyright @ <?php echo date("Y"); ?></p>
      </footer>
